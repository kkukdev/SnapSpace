...
public class Indicators implements Runnable {
    ...
    public Indicators(AbstractActivity main) {
        ...
        mLayoutInfo = main.findViewById(com.snapspace.scanner.R.id.layout_info);
        mInfoLeft = main.findViewById(com.snapspace.scanner.R.id.info_left);
        mInfoRight = main.findViewById(com.snapspace.scanner.R.id.info_right);
        mInfoLog = main.findViewById(com.snapspace.scanner.R.id.infolog);
        mBattery = main.findViewById(com.snapspace.scanner.R.id.info_battery);
        mInfoLog = main.findViewById(com.snapspace.scanner.R.id.infolog);
    ...
    public void run()
    {
        while (mRunning) {
            ...
            mMain.runOnUiThread(() -> {
                ...
                int icon = com.snapspace.scanner.R.drawable.ic_battery_0;
                if (bat > 10)
                    icon = com.snapspace.scanner.R.drawable.ic_battery_20;
                if (bat > 30)
                    icon = com.snapspace.scanner.R.drawable.ic_battery_40;
                if (bat > 50)
                    icon = com.snapspace.scanner.R.drawable.ic_battery_60;
                if (bat > 70)
                    icon = com.snapspace.scanner.R.drawable.ic_battery_80;
                if (bat > 90)
                    icon = com.snapspace.scanner.R.drawable.ic_battery_100;
