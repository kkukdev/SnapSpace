...
public abstract class AbstractActivity extends Activity {
  ...
  public static float getResolution(Context context)
  {
    ...
    String value = pref.getString(context.getString(com.snapspace.scanner.R.string.pref_resolution), "0.04");
  ...
  public static boolean isCameraFeedOn(Context context) {
    SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
    return pref.getBoolean(context.getString(com.snapspace.scanner.R.string.pref_camera), false);
  }

  public static boolean isFaceModeOn(Context context)
  {
    SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
    return pref.getString(context.getString(com.snapspace.scanner.R.string.pref_mode), "realtime").compareTo("face") == 0;
  }
  ...
  public static boolean isPostProcessLaterOn(Context context) {
    SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
    boolean later = pref.getBoolean(context.getString(com.snapspace.scanner.R.string.pref_later), false);
    String mode = pref.getString(context.getString(com.snapspace.scanner.R.string.pref_mode), "realtime");
  ...
  public static boolean isTofOn(Activity activity)
  {
    ...
    String key = activity.getString(com.snapspace.scanner.R.string.pref_depth);
