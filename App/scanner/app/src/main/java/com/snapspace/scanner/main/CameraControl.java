...
public class CameraControl {
    ...
    public enum ViewMode { UNKNOWN, FACE, ORBIT, TOPDOWN, FIRST, FLOORPLAN };
    ...
    public CameraControl(Main activity, DistanceMeasuring distanceMeasuring, Editor editor) {
        ...
        mFirstViewButton = activity.findViewById(com.snapspace.scanner.R.id.first_button);
        mOrbitViewButton = activity.findViewById(com.snapspace.scanner.R.id.orbit_button);
        mTopViewButton = activity.findViewById(com.snapspace.scanner.R.id.topview_button);
            ...
            if (mShareThumbnail) {
                ...
                if (bitmap != null) {
                    try {
                        ...
                        mActivity.startActivity(Intent.createChooser(intent, mActivity.getString(com.snapspace.scanner.R.string.share_via)));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
